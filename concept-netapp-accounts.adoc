...
The Manage Account widget in BlueXP enables Account Admins to manage an account. If you just created your account, then you'll start from scratch. But if you've already set up an account, then you'll see _all_ the users, workspaces, and Connectors that are associated with the account.
