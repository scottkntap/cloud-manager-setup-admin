...
image:screenshot-account-selection.png[A screenshot of the BlueXP setup wizard that prompts you for the NetApp account in which you want to create BlueXP.]
...
The Manage Account widget in BlueXP enables Account Admins to manage a NetApp account. If you just created your account, then you'll start from scratch. But if you've already set up an account, then you'll see _all_ the users, workspaces, and Connectors that are associated with the account.
