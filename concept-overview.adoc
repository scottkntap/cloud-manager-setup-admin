...
* Enable integrated cloud services like https://cloud.netapp.com/cloud-compliance[Cloud Data Sense^], https://cloud.netapp.com/cloud-insights[Cloud Insights^], https://cloud.netapp.com/cloud-backup-service[Cloud Backup^], and more.
