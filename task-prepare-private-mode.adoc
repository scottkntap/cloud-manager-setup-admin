...
How you provide permissions depends on where you're installing the Connector:

AWS permissions::
If you install the Connector on premises, you must provide AWS permissions using IAM access keys.
+
If you install the Connector in AWS, you can choose from two options:

* Attach an IAM role to the Connector instance
* Provide AWS access keys for an IAM user

Azure permissions::
If you install the Connector on premises, you must provide Azure permissions using an Azure AD service principal.
+
If you install the Connector in Azure, you can choose from two options:

* Attach an IAM role to the Connector instance
* Provide AWS access keys for an IAM user

Google Cloud permissions::
In order to create Cloud Volumes ONTAP systems in Google Cloud, then the Connector must be in Google Cloud as well. You can provide permissions to the Connector VM through a service account. 
...
How you prepare cloud permissions depends on whether you plan to install the Connector in the cloud or on your premises.

=== Prepare cloud permissions when the Connector is installed in the cloud
...
=== Prepare cloud permissions when the Connector is installed on premises

On-prem is only AWS keys or a service principal.
