...
[role="quick-margin-para"]
In most cases, a BlueXP Account Admin will need to create a Connector in your cloud or on-premises network. The Connector is NetApp software that enables BlueXP to manage resources and processes within your hybrid cloud environment.
