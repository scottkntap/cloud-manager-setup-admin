...
[NOTE]
====
* At this time, only Cloud Sync, Cloud Backup, and Ransomware Protection are sending notifications by email. Additional services will be added in future releases.
...
. From the BlueXP menu bar, click *Settings > Alerts and Notifications Settings*.
+
...
To dismiss all notifications, in the Notification Center, click image:button_3_vert_dots.png[an icon with three vertical dots] and select *Dismiss All*.
...
. From the BlueXP menu bar, click *Settings > Timeline*.
