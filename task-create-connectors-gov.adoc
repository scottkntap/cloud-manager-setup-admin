...
[.lead]
To use BlueXP in restricted mode, you need to install the Connector and then set up BlueXP by accessing the user interface that's running on the Connector.
...
.. Expand the option to *Enable restricted mode on this account*.
