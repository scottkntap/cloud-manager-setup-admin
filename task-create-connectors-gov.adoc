...
If you want to use Cloud Volumes ONTAP, provide BlueXP with the permissions that you previously set up.
--
...
Now that you've deployed the Connector, you need to provide the permissions that you previously set up so that BlueXP can deploy Cloud Volumes ONTAP in a virtual network.
