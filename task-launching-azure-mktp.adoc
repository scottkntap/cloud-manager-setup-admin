...
. https://azuremarketplace.microsoft.com/en-us/marketplace/apps/netapp.netapp-oncommand-cloud-manager[Go to the NetApp Connector VM page in the Azure Marketplace^]
