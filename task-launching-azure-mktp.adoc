...
summary: It's best to create a Connector directly from BlueXP, but you can launch a Connector from the Azure Marketplace, if you prefer. After you create and set up the Connector, Cloud MBlueXPutomatically use it when you create new working environments.
---
...
If the Connector is in an Azure commercial region, open a web browser and go to https://cloudmanager.netapp.com to start using the Connector with BlueXP.
...
+
NOTE: BlueXP Operator is the default name provided in the Cloud MBlueXP. If you chose a different name for the role, then select that name instead.
