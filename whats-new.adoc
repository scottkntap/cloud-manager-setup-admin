...
summary: "Learn what's new with BlueXP administration features: NetApp accounts, Connectors, cloud provider credentials, and more."
---
...
[.lead]
Learn what's new with BlueXP administration features: NetApp accounts, Connectors, cloud provider credentials, and more.
...
+
After you discover a VMware vCenter Server, you can open the working environment to view details about the datastores and virtual machines that are associated with the server.
+
The only requirement is a Connector that has a connection to a VMware vCenter Server running version 7.0 or later. 
+
To get started, click *Add Working Environment > On-Premises > VMware vCenter Server*, enter the domain name or IP address for the server, and then enter the user name and password for the admin user.
...
+
link:task-manage-user-credentials.html[Learn how to manager user credentials].
...
+
** https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/whats-new.html#2-april-2023[Learn about Cloud Volumes ONTAP enhancements^]

** https://docs.netapp.com/us-en/cloud-manager-ontap-onprem/whats-new.html#2-april-2023[Learn about ONTAP on-prem cluster enhancements^]
