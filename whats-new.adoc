...
BlueXP _deployment modes_ enable you to use BlueXP in a way that meets your business requirements for data security and privacy. When you get started with BlueXP and set up your account, you can choose from three modes:
