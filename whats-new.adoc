...
* The Connector is now supported in cloud regions that have complete isolation from the internet. This enables you to use BlueXP to deploy Cloud Volumes ONTAP in cloud regions where no internet access is available.
+
