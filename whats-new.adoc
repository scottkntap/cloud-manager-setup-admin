...
+
The only requirements are a Connector that has a connection to a VMware vCenter Server running version 7.0 or later. 
+
...
* You can now upload attachments when you create a support cases or when you update the case notes for an existing support case.
+
