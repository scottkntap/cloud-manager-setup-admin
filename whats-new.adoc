...
summary: Learn about new features related to Cloud Manager's administration features, including NetApp accounts, Connectors, cloud provider credentials, and more.
---
...
[.lead]
Learn about new features related to Cloud Manager's administration features: NetApp accounts, Connectors, cloud provider credentials, and more.
...
=== Update to NetApp Support Site accounts
...
link:reference-networking-cloud-manager.html#outbound-internet-access[View the list of required endpoints].
...
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-setting-up-ontap-cloud.html[Learn more about configuring AutoSupport with Cloud Volumes ONTAP^]
...
=== RHEL 7.9 support for the Connector

The Connector is now supported on a host that's running Red Hat Enterprise Linux 7.9.

link:reference-cloud-mgr-reqs.html[View system requirements for the Connector].
...
link:task-managing-cloud-central-accounts.html[Learn how to filter the Timeline to the Tenancy service].
...
link:task-managing-cloud-central-accounts.html#creating-and-managing-service-accounts[Learn more about using service accounts].
...
link:task-managing-cloud-central-accounts.html#allowing-private-previews[Learn more about these options].
