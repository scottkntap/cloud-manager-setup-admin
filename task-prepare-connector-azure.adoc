---
sidebar: sidebar
permalink: task-prepare-connector-azure.html
...
= Prepare for Connector installation in Azure
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
The installation option that you choose impacts how you prepare for installation. This includes how you provide 
...
If your organization requires a proxy server for all outgoing internet traffic, obtain the following information about your proxy server:
