...
| 1 | AD admin a| Configure the ADFS server to enable identity federation with our authentication provider (auth0).
...
| 2 | BlueXP admin a| Create a connection from the ADFS server to BlueXP from the https://services.cloud.netapp.com/federation-setup[NetApp Federation Setup page^]
...
| 1 | AD admin a| Create a new connection with the SAML identity provider.
...
| 2 | BlueXP admin a| Create a connection from the SAML identity provider to BlueXP from the https://services.cloud.netapp.com/federation-setup[NetApp Federation Setup page^]
...
| 1 | AD admin a| Create a new connection with the PingFederate server.
