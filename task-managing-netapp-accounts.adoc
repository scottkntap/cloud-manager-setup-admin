...
== Disable the SaaS platform

You should disable the SaaS platform only if you want to use BlueXP in restricted mode. You might want to use restricted mode to comply with your company's security policies.
...
CAUTION: This is an irreversible action that will prevent you from using the BlueXP SaaS platform. As a result, you'll need to perform actions from the local Connector and you won't have the ability to use many of BlueXP's services. Re-enabling the SaaS platform will require the help of NetApp support.

.Steps

. link:concept-modes.html[Understand about how BlueXP works in restricted mode].
