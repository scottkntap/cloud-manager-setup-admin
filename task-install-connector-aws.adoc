...
Now that you've deployed the Connector, you need to provide the permissions that you previously set up so that you can use Cloud Volumes ONTAP, Cloud Backup, and Cloud Data Sense from BlueXP.
