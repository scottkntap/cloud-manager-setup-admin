...
[.lead]
Create the Connector in AWS directly from the BlueXP user interface, from the AWS Marketplace, or by installing the software on your own Linux host.
...
+
https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/iam-roles-for-amazon-ec2.html#attach-iam-role[AWS documentation: Attach an IAM role to an instance^]
