...
[.lead]
Create the Connector in AWS and then set it up for use with BlueXP.

== Install the Connector

Create the Connector directly from the BlueXP user interface, from the AWS Marketplace, or by installing the software on your own Linux host.
...
After you manually install the Connector software on your own Linux host, you need to provide BlueXP with the permissions that you previously set up.
