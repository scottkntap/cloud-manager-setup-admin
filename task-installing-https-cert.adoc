...
BlueXP now uses the CA-signed certificate to provide secure HTTPS access. The following image shows a Cloud MBlueXPt that is configured for secure access:
...
You should renew the BlueXP HTTPS certificate before it expires to ensure secure access to the Cloud MBlueXPnsole. If you do not renew the certificate before it expires, a warning appears when users access the web console using HTTPS.
