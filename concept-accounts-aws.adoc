...
image:diagram_permissions_initial_aws.png["A conceptual image that shows Cloud Central deploying BlueXP in an AWS account. An IAM policy is assigned to an IAM role, which is attached to the Cloud MBlueXPce."]
