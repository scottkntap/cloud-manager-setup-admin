...
[role="quick-margin-para"]
When you create the Connector VM, you need to associate it with a service account that is associated with a custom role that has permissions to manage resources in Google Cloud.
