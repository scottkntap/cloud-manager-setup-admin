...
[.lead]
A BlueXP Account Admin needs to deploy a _Connector_ before you can use most BlueXP features. link:concept-connectors.html[Learn when a Connector is required]. The Connector enables BlueXP to manage resources and processes within your hybrid cloud environment.
