...
Standard mode::
BlueXP is accessible to users as a cloud service from a SaaS website. Depending on the BlueXP services that you're planning to use, a BlueXP admin creates one or more Connectors to manage resources and process within your hybrid cloud environment. 
+
