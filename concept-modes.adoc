...
Private mode::
A BlueXP Connector is installed on premises or in the cloud (in a sovereign cloud region or commercial region) and has no connectivity to the BlueXP SaaS backend. Users access BlueXP locally from the Connector, not from the SaaS website.
+
