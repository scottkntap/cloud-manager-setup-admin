...
Restricted mode::
A BlueXP Connector is installed in the cloud: in a government region, sovereign cloud region, or commercial region and has outbound unidirectional connectivity to the BlueXP SaaS backend. Users access BlueXP locally from the Connector, not from the SaaS website.
+
