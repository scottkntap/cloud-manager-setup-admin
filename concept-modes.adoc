...
The following image shows a typical hybrid cloud deployment when using BlueXP in private mode.

image:diagram-private-mode-cloud.png[A conceptual image...]

The following image shows a typical on-premises deployment when using BlueXP in private mode.
