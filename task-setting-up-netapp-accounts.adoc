...
. From the top of https://cloudmanager.netapp.com[BlueXP^], click the *Account* drop-down.
+
...
. From the top of https://cloudmanager.netapp.com[BlueXP^], click the *Account* drop-down and click *Manage Account*.
+
image:screenshot-manage-account-settings.png[A screenshot that shows the Manage Account Settings option that's available from the Account drop-down.]
