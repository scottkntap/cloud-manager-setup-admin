...
. Download the BlueXP software from the https://mysupport.netapp.com/site/products/all/details/cloud-manager/downloads-tab[NetApp Support Site^], and then copy it to the Linux host.
+
...
+
BlueXP is now installed. At the end of the installation, the Cloud MBlueXPe (occm) restarts twice if you specified a proxy server.
