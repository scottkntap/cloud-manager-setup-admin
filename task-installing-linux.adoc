...
The Connector is now installed and set up with your BlueXP account. BlueXP will automatically use this Connector when you create new working environments.
