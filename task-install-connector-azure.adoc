...
The Connector is now installed and is set up with your NetApp account.
...
If you installed the Connector from the Azure Marketplace or by manually installing the software, then you'll need to add permissions to the Connector.
