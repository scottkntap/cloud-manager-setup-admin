...
If you installed the Connector from the Azure Marketplace, you need to assign the custom role that you created to the Connector VM in Azure.

If you manually installed the Connector software, then you need to provide BlueXP with details about the Azure AD service principal that you created.
