...
= Install the Connector in Azure
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
Install the Connector in Microsoft Azure directly from the BlueXP user interface, from the Azure Marketplace, or by installing the software on your own Linux host.
...
. In the Azure portal, go to the *Access Control (IAM)* page for the Connector VM and click *Add > Add role assignment* to assign the custom role that you created for the Connector. 
+
...
. In the Azure portal, go to the *Access Control (IAM)* page for the Connector VM and click *Add > Add role assignment* to assign the custom role that you created for the Connector. 
+
Be sure to assign the role to the managed identity for the Connector VM.
+
