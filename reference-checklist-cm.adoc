...
.AWS
--
include::task-creating-connectors-aws.adoc[tag=endpoints]
--

.Azure
--
include::task-creating-connectors-azure.adoc[tag=endpoints]
--

.Google Cloud
--
include::task-creating-connectors-gcp.adoc[tag=endpoints]
--
=====
// end tabbed area
