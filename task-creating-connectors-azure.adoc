...
When you create the Connector from BlueXP, you need to provide the application (client) ID and the directory (tenant) ID for the application. Cloud MBlueXPhe IDs to programmatically sign in.
...
You need to create a client secret and then provide BlueXP with the value of the secret so Cloud MBlueXPe it to authenticate with Azure AD.
