...
. To associate the credentials with a new subscription, click *Add Subscription* and follow the steps in the AWS Marketplace:
...
+
image:screenshot-aws-subscription.png[]
