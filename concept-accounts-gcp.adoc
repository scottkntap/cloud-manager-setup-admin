...
* link:task-creating-connectors-gcp.html#setting-up-gcp-permissions-to-create-a-connector[Learn how to set up service account (see step 2)].
* link:task-deploying-gcp.html[Learn how to deploy Cloud Volumes ONTAP in GCP and select a project].

== Account for data tiering

TIP: Cloud Manager requires a GCP account for Cloud Volumes ONTAP 9.6, but not for 9.7 and later. If you want to use data tiering with Cloud Volumes ONTAP 9.7 or later, then follow step 4 in link:task-getting-started-gcp.html[Getting started with Cloud Volumes ONTAP in Google Cloud Platform].
...
* link:task-adding-gcp-accounts.html[Learn how to set up and add GCP accounts to Cloud Manager].
* link:task-tiering.html[Learn how to tier inactive data to low-cost object storage].
