...
The following permission was added to the JSON policy. It's required for Cloud Backup and Cloud Tiering.

Microsoft.Storage/storageAccounts/blobServices/containers/write

The following permissions were removed from the JSON policy. They are no longer required.
