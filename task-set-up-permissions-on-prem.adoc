...
[.lead]
If you want to use BlueXP services in AWS or Azure, then you need to set up permissions in your cloud provider so that you can add the credentials to the Connector after you install it.
