...
The user who creates a Connector from BlueXP needs specific permissions to deploy the instance in your cloud provider of choice. Cloud MBlueXPemind you of the permissions requirements when you create a Connector.
...
When you create a Connector directly from BlueXP, Cloud MBlueXPs the Connector with the permissions that it needs. There's nothing that you need to do.
