...
* https://s3.amazonaws.com/occm-sample-policies/Policy_for_Setup_As_Service_Azure.json[View the required Azure permissions^]
* https://occm-sample-policies.s3.amazonaws.com/Setup_As_Service_3.7.3_GCP.yaml[View the required Google Cloud permissions^]
