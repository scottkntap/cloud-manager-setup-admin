...
* https://mysupport.netapp.com/site/info/cloud-manager-policies[View policies for each cloud provider^]
* link:reference-permissions.html[Learn how Cloud Manager uses cloud provider permissions]

TIP: After you create a Connector in AWS, you can add an additional set of AWS credentials to enable the Connector to deploy and manage Cloud Volumes ONTAP in other AWS accounts. link:task-adding-aws-accounts.html[Learn how to manage AWS credentials and subscriptions].
...
+
* link:task-adding-ontap-cloud.html[Adding existing Cloud Volumes ONTAP systems to Cloud Manager]
* link:task-discovering-ontap.html[Discovering ONTAP clusters]
. Set the link:concept-storage-management.html#capacity-management[Capacity Management Mode] to *Manual* on any additional Connectors.
+
...
link:task-managing-connectors.html#switch-between-connectors[Learn how to switch between Connectors].
...
link:task-managing-connectors.html#accessing-the-local-ui[Learn how to access the local UI].
