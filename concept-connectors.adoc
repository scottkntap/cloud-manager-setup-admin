...
== Connectors in restricted mode and private mode

When you use BlueXP in restricted mode or private mode, you get started with BlueXP by installing the Connector and then accessing the user interface or API on the Connector.

link:concept-modes.html[Learn about BlueXP deployment modes].

== Permissions

Specific permissions are needed to create the Connector directly from BlueXP and another set of permissions are needed for the Connector instance itself.
