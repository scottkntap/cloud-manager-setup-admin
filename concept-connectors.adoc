...
+
* https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-adding-ontap-cloud.html[Add existing Cloud Volumes ONTAP systems to Cloud Manager^]
...
link:task-managing-connectors.html[Learn how to access the local UI^].
