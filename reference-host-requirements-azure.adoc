...
Managed identity::
If you're using your own Linux VM in Azure, a managed identity must be enabled on the VM so that you can provide the required Azure permissions through a custom role.
+
