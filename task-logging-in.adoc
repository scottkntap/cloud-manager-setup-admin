...
summary: After you sign up to BlueXP, you can log in from your web browser through the web-based console. 
---
...
[.lead]
After you sign up to BlueXP, you can log in from the web-based console. 
