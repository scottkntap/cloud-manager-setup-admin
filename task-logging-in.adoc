...
. On the *Log in* page, enter the email address that's associated with your account.

. Depending on how you signed up, you'll be prompted to enter your credentials:
+
