...
When new versions of the Connector software are available, they'll be posted to the NetApp Support Site. https://docs.netapp.com/us-en/cloud-manager-connector/task-managing-connectors.html[Learn how to upgrade the Connector^]
