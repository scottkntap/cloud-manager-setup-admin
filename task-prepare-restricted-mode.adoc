...
=== Prepare AWS permissions (list both options)
...
=== Prepare Azure permissions (list both options)

You have two options:

. Provide permissions by creating a custom role and then assign it to the Connector VM.
. Provide permissions through an Azure AD service principal
...
=== Prepare Google Cloud permissions
