...
For example, you should understand that you need to use the user interface that is available locally from the BlueXP Connector that you need to install. You can't access BlueXP from the SaaS website.
