...
[.lead]
You should understand what's needed before you deploy the BlueXP Connector in restricted mode so that you can prepare your environment. When you use BlueXP in restricted mode, you need to use the BlueXP user interface that's running on the Connector. You can't access BlueXP from the SaaS website.
