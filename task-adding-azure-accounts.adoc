...
You can now switch to different set of credentials from the Details and Credentials page link:task-deploying-otc-azure.html[when creating a new working environment]:
