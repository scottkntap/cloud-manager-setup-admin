...
.. Click *Create*.
.. Fill out form and click *Subscribe*.
.. Click *Notifications* and click the link in the notification to configure your account.
...
+
image:screenshot-azure-subscription.png[A screenshot of the Subscription Assignment page that enables you to associate this subscription with one or more accounts and choose to replace the existing subscription for one of those accounts.]
