...
If you manually install the Connector software on your own Linux host in Azure, you can provide permissions in the following ways:
...
. Enable a system-assigned managed identity on the VM where you're planning to install the Connector software so that you can provide the required Azure permissions through a custom role. 
+
