...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-1.png[One] Set up authentication and permissions

[role="quick-margin-para"]
Some words and a link.
...
== Set up AWS permissions and authentication
